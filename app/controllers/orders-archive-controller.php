...
if (!function_exists('orders_archive_index')) {
    function orders_archive_index(): void
    {
        ...
        if (!$has_inbox_table) {
            ...
            $filtered_total = order_count_inbox_filtered($current_pid, true, $search, $status_filter, $selected_dh_year);
            ...
            $items = order_list_inbox_page_filtered($current_pid, true, $search, $status_filter, $per_page, $offset, $sort, $selected_dh_year);
